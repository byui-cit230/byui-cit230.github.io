// get the container to build within
var section = document.querySelector('#home-two');

// get the JSON data using XMLHttpRequest Object
...
request.onload = function() {
    ...
    for (var i = 0; i < towns.length; i++)
    {
        ...
        myImj.setAttribute('src', 'images/'+towns[i].name + '.jpg');
        myImj.setAttribute('alt', 'The city of ' + towns[i].name + ' picture');
